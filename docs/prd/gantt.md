...
│   ├── 3.2 五条标准工作流 + 1 条顺延 V2 ..... P3-05~10
│   │   ├── 文生图 ✅ 已单张验证
│   │   ├── 图生图
│   │   ├── 高清修复
│   │   ├── 局部重绘
│   │   ├── 风格迁移 ❌ **顺延 V2**（ADR-008 裁定 1）
│   │   └── 批量出图
│   ├── 3.3 版本化与元数据 ................... P3-11
│   └── 3.4 参数模板库 ....................... P3-12
│
...
gantt
    ...
    五条标准工作流           :crit,    p3b, 2026-09-30, 8d
...
| **M3 工作流可用** | 10-11 | ⬜ | **5 条**工作流 + 注册表 | **5 条**全部稳定出图，参数可外部注入（**1 条顺延 V2**，见 `../adr/0008-v1-scope-reduction.md`） | 3.x |
...
```
P2-07 环境复现 ──▶ P3-01 工作流规范 ──▶ P3-05 五条工作流（+1 条顺延 V2）
                                             │
                                             ▼
                                     P6-01 任务API + 状态机
                                             │
...
| P3-05 五条工作流（+1 条顺延 V2，见 `../adr/0008-v1-scope-reduction.md`） | 一切上层功能的地基 | 前端/队列无内容可跑 |
