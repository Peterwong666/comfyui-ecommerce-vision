...
> ⚠️ **2026-09-23 补登时发现：总完成数口径不自洽（待核）** —— `项目进度.md` §0 写 **75 / 153**（其括号内成分求和实为 **80**）、§2 末尾写 **70**；而本文件的实际标记给出 **P1 18/20**（§2 写 20）与 **P7 6/12**（§2 写 8）。
> **本表补登各行一律沿用当时记载的计数，未重新裁定**；核对前**不要**引用总完成数。详见 `项目进度.md` §10 末注。
